    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-teal-500/30 selection:text-teal-300 overflow-x-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          >
            <div className=" rounded-xl flex   shadow-lg shadow-teal-500/20 group-hover:rotate-12 transition-transform duration-300">
              <img src="logop.jpg" alt="logo" className="w-7 h-7" />
            </div>
